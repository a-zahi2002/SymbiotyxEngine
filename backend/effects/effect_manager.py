...
class EffectManager:
    ...
    def run_window(self) -> None:
        """
        Runs the Arcade visualization window.
        """
        if not ARCADE_AVAILABLE:
            print("[VFX] Python Arcade is not installed. VFX window disabled.")
            return
        ...
        # Run Arcade in a daemon thread so it does not block the main FastAPI server
